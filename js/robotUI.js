function RobotUI() {
    ...
    function renderAppGamePaused() {
        ...
        ctx.font = '50px serif';
        ctx.fillStyle = 'Black';
        ctx.fillText('Game Paused', screenX + 320, screenY + 100);
        ...
        //button resume text
        ctx.fillStyle = 'Black';
        ctx.fillText('Resume', screenX + buttonXOffset+ 125, screenY + 210);
        ...
        //button restart text
        ctx.fillStyle = 'Black';
        ctx.fillText('Restart', screenX + buttonXOffset+125, screenY + 360);
    ...
    function renderAppGameOver() {
        ...
        //button restart text
        ctx.fillStyle = 'Black';
        ctx.fillText('Replay', screenX + buttonXOffset+125, screenY + 360);
